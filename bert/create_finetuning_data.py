...
flags.DEFINE_enum("classification_task_name", "MNLI",
                  ["COLA", "MNLI", "MRPC", "XNLI", "QuestionClassification"],
...
def generate_classifier_dataset():
  ...
  #     "questionclassification": classifier_data_lib.QuestionClassificationProcessor
  # }
  # task_name = FLAGS.classification_task_name.lower()
  # if task_name not in processors:
  #   raise ValueError("Task not found: %s" % (task_name))

  processor = classifier_data_lib.QuestionClassificationProcessor(FLAGS.input_data_dir)
